...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
        <div class="card-header text-white" style="background-color: gold;">
    ...
    <a href="index.php?page=barang" style="color: gold;">Tabel Barang <i class="fa fa-angle-double-right"></i></a>
</div>
    ...
    <h6 class="pt-2"><i class="fas fa-upload"></i> Telah Terjual</h6>
            ...
            <div class="card-footer">
    <a href="index.php?page=laporan" style="color: gold;">Tabel laporan <i class="fa fa-angle-double-right"></i></a>
</div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
    ...
    <h6 class="pt-2"><i class="fa fa-bookmark"></i> Kategori Barang</h6>
            ...
            <div class="card-footer">
    <a href="index.php?page=kategori" style="color: gold;">Tabel Kategori <i class="fa fa-angle-double-right"></i></a>
</div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
